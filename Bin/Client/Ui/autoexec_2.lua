...
AddCommand("H", "", "Switch([[pk]])")
AddCommand("T", "", "Open([[tong]])")
...
AddCommand("Ctrl+A", "","Open([[autoplay]])")
AddCommand("Ctrl+F", "", "Switch([[OFautoplay]])")
AddCommand("Ctrl+Z", "", "Open([[openbox]])")
...
AddCommand("PageDown", "", "SwitchChannel()")
...
AddCommand("Space", "","Switch([[pickupobj]])")
