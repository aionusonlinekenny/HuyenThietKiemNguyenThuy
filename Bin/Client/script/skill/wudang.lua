...
--		physicsenhance_p={{{1,15},{20,180}}},
	...
	wudang120={ --Xuat U Bat Nhiem 120
		...
		skill_desc=
			function(level)
				...
				"X竎 su蕋 <color=orange>"..floor(100 - Link(level,SKILLS.wudang120_child.missle_missrate[1])).."%<color> <color>t?lo筰 b?v?mi詎 d辌h tr竛g th竔 d?thng trong <color=orange>"..
	...
	qiwudang150={ --Tao Hoa Thai thanh -150
		...
		addskillexp1={{{1,1078},{2,1078}},{{1,EXP_PER},{20,EXP_PER}},{{1,0},{2,0}}},
		skill_skillexp_v={{	{1,180},
							{2,460},
							{3,920},
							{4,1840},
	...
	jianwudang150={ --Kiem Thuy Tinh Ha-150
		...
		skill_showevent={{{1,0},{10,0},{10,1},{15,1},{15,5},{20,5}}},
		addskillexp1={{{1,1079},{2,1079}},{{1,EXP_PER},{20,EXP_PER}},{{1,0},{2,0}}},
		skill_skillexp_v={{	{1,180},
							{2,460},
							{3,920},
							{4,1840},
