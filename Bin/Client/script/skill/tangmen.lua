...
SKILLS={
	...
	feidaotang150={ --Vo Anh xuyen - 150
		...
		skill_attackradius={{{1,448},{20,512},{21,512}}},
		addskillexp1={{{1,1069},{2,1069}},{{1,EXP_PER},{20,EXP_PER}},{{1,0},{2,0}}},
		skill_skillexp_v={{	{1,180},
							{2,460},
							{3,920},
							{4,1840},
	...
	nutang150={ --Thiet Lien Tu Sat -150
		...
		skill_showevent={{{1,0},{10,0},{10,2},{20,2}}},
		addskillexp1={{{1,1070},{2,1070}},{{1,EXP_PER},{20,EXP_PER}},{{1,0},{2,0}}},
		skill_skillexp_v={{	{1,180},
							{2,460},
							{3,920},
							{4,1840},
	...
	biaotang150={ --Can Khon Nhat Trich-150
		...
		addskillexp1={{{1,1071},{2,1071}},{{1,EXP_PER},{20,EXP_PER}},{{1,0},{2,0}}},
		skill_skillexp_v={{	{1,180},
							{2,460},
							{3,920},
							{4,1840},
