...
--	},
	...
	zhanren150={ --Giang Hai no Lan -150
		...
		skill_desc=
			function(level)
				...
				return "T╪g th猰 h譶h th鴆 th?hai<color=blue> Ma ﹎ k輈h <color> v韎 <color=orange>"..floor(100 -Link(level,SKILLS.zhanren150.missle_missrate[1])).."%<color>T?l?khi課 cho i phng khi誴 s?"..
		...
		addskillexp1={{{1,1075},{2,1075}},{{1,EXP_PER},{20,EXP_PER}},{{1,0},{2,0}}},
		skill_skillexp_v={{	{1,180},
							{2,460},
							{3,920},
							{4,1840},
	...
	moren150={ --Tat Hoa Lieu nguyen -150
		...
		addskillexp1={{{1,1076},{2,1076}},{{1,EXP_PER},{20,EXP_PER}},{{1,0},{2,0}}},
		skill_skillexp_v={{	{1,180},
							{2,460},
							{3,920},
							{4,1840},
