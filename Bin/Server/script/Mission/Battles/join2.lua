...
function main()
	...
	Say("ChiÕn tr­êng ®· b¾t ®Çu! HiÖn t¹i bªn <color=plum>Kim: "..nJinCount.."<color> ng­êi, bªn <color=sbrown>Tèng: "..nSongCount.."<color> ng­êi, ng­¬i cã muèn gia nhËp qu©n ®éi ®Ó phôc vô ®Êt n­íc kh«ng?", 3,
