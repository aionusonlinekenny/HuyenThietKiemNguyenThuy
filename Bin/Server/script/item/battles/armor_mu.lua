...
function add477() 
	...
	AddSkillState(477, level, 1, 1080)
	Msg2Player("<color=OrangeRed>§¹i hiÖp ®· nhËn ®­îc 1 phót t¨ng "..(level*10).."% kh¸ng l«i.<color>")
end 

Tab={add477,add477,add477}
