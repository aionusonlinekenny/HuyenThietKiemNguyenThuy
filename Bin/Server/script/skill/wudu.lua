...
--		},
	...
	wudu120={ --Hap Tinh yem skill 120
		...
		skill_desc=
			function(level)
				return "X¸c suÊt <color=orange>"..floor(Link(level,SKILLS.wudu120.autoattackskillplus[1])).."%<color> khiÕn cho ®èi ph­¬ng bÞ ®éc s¸t,\n"..
				...
				" <color=orange>"..floor(Link(level,SKILLS.wudu120.autoattackskillplus[3]) / 18).." gi©y<color> sau míi cã thÓ thi triÓn tiÕp"
			end,
