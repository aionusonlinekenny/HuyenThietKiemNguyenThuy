...
unsigned int KWndButton::ms_uBtnTipTextColor = 0xffffffff;	
int			 KWndButton::ms_nDisableBtnTip   = false;
...
//
// --
void KWndImageTextButton::SetWorldRankText(int nNumber, char Separator)
{
	m_Text.SetWorldRankText(nNumber, Separator);
}

// --
//
// --
void KWndImageTextButton::SetText(const char* pText, int nLen)	
{
...
//
// --
int	KWndImageTextButton::GetText(char* pBuffer, int nSize)		
{
