...
//          ShowCaret(::g_GetMainHWnd());
		...
		nRet = m_pParentWnd->WndProc(WND_M_SET_FOCUS, (unsigned int)(KWndWindow*)this, 0);
		break;
...
//
KWndEdit06::KWndEdit06() //LockPlayer by kinnox;
{
	m_Text[0] = m_Text[6] = 0;
	SetTextPtr(m_Text, 7);
}
...
KWndEdit128::KWndEdit128()
{
	m_Text[0] = m_Text[127] = 0;
	SetTextPtr(m_Text, 128);
}
