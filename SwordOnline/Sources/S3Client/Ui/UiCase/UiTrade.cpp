...
#define	STR_WAIT_TRADING		"ChÍ x∏c nhÀn"
#define	STR_OTHER_OK			"ßËi ph≠¨ng Æ∑ ÆÂng ˝"
#define	STR_OTHER_NOT_OK		"ßËi ph≠¨ng ch≠a ÆÂng ˝"
...
void KUiTrade::Initialize()
{
	...
	m_OtherMoney.SetMoneyText(0);
	m_TakewithMoney.SetMoneyText(0);
	m_Info.SetText("", 0);
