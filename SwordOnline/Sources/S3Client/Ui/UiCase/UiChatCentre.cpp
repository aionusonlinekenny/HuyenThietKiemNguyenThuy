...
{
	"G鰅 tin t鴆",	"X鉧", "Di chuy觧"
};

#define FRIEND_INDEX	0
#define FRIEND_UNITNAME "B筺 h鱱"

#define BROTHER_INDEX	1
#define BROTHER_UNITNAME "Th﹏ nh﹏"
...
void KUiChatCentre::UpdateAll(int nCurGroup)
{
	...
	std::string strName = m_AllFriendUnits[m_nCurentFriendUnit].m_UnitName;
