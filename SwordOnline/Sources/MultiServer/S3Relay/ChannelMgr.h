...
#include <map>
#include <list>
static const int MAX_PLAYER_ANTI_PAKET = 1024;
...
private:
	...
	TCHAR m_chChannBATTLE;
	
	DWORD m_ArrPaketAnti[MAX_PLAYER_ANTI_PAKET][2];
private:
	DWORD GenChannID();
...
private:
	...
	BOOL IsValidBattleID(DWORD idBattle);
	
	BOOL AddAntiPaket(DWORD srcIp, DWORD timer);	
private:
	DWORD m_lastChannID;
