...
bool CPlayerCreator::GetRoleDataFromIni(BYTE* pData, const char* szFileName)
{
	...
	pRoleData->BaseInfo.lockboxrole = 0;//LockPlayer by kinnox;
	pRoleData->BaseInfo.iexpandboxrole = 0;//Expandbox by kinnox;
...
//  Skill
	...
	for( i = 0 ; i < nItemCount; i ++)
	{
		...
		pItemData->igenre			= cFile.ReadInteger(szSection, "iequipclasscode", 0);
		...
		pItemData->imagiclevel1		= cFile.ReadInteger(szSection, "iparam1", 0);
		pItemData->imagiclevel2		= cFile.ReadInteger(szSection, "iparam2", 0);
		pItemData->imagiclevel3		= cFile.ReadInteger(szSection, "iparam3", 0);
		pItemData->imagiclevel4		= cFile.ReadInteger(szSection, "iparam4", 0);
		pItemData->imagiclevel5		= cFile.ReadInteger(szSection, "iparam5", 0);
		pItemData->imagiclevel6		= cFile.ReadInteger(szSection, "iparam6", 0);
		pItemData->iversion			= cFile.ReadInteger(szSection, "iequipversion", 0);
		...
		pItemData->irecord			= cFile.ReadInteger(szSection, "irecord", 0);
		pItemData->ibindstate		= 0;
		pItemData->iexpiredtime		= 0;
		pItemData->ishopprice		= 0;
