...
private:
	...
	OnlineGameLib::Win32::_tstring	m_sLicense;
...
protected:
	...
	bool _QueryRoleInfo_ToDBRole( const char *pRoleName, bool bCheck = false );
	bool _CheckRoleInfo_ToGameServer( const void *pData, size_t dataLength );
