...
BOOL KIniFile::Load(LPCSTR FileName)
{
	...
	m_FileNameId = g_FileName2Id((char*)FileName);
...
//
// --
BOOL KIniFile::GetShort(
	LPCSTR lpSection,		// points to section name
	LPCSTR lpKeyName,		// points to key name
	short   nDefault,		// default value
	short   *pnValue        // points to value
	)
{
	char Buffer[32];
...
//
// --
void KIniFile::GetShort2(
	LPCSTR lpSection,		// points to section name
	LPCSTR lpKeyName,		// points to key name
	short   *pnValue1,		// value 1
	short   *pnValue2		// value 2
	)
{
	char  Buffer[32];
	char* pChar = Buffer;
