...
void KNpcTemplate::InitNpcLevelData(KTabFile * pKindFile, int nNpcTemplateId, KLuaScript * pLevelScript, int nLevel, int nSeries)
{
	...
	pLevelScript->SafeCallBegin(&nTopIndex);
	{
		...
		if (szValue1[0] && szValue2[0])
			m_SkillList.SetNpcSkill(1, GetNpcLevelDataFromScript(pLevelScript, "Skill1", nSeries, nLevel, szValue1) , GetNpcLevelDataFromScript(pLevelScript, "Level1", nSeries, nLevel, szValue2));
		...
		if (szValue1[0] && szValue2[0])
			m_SkillList.SetNpcSkill(2, GetNpcLevelDataFromScript(pLevelScript, "Skill2", nSeries, nLevel, szValue1), GetNpcLevelDataFromScript(pLevelScript, "Level2", nSeries, nLevel, szValue2));
		...
		if (szValue1[0] && szValue2[0])
			m_SkillList.SetNpcSkill(3, GetNpcLevelDataFromScript(pLevelScript, "Skill3", nSeries, nLevel, szValue1), GetNpcLevelDataFromScript(pLevelScript, "Level3", nSeries, nLevel, szValue2));
		...
		if (szValue1[0] && szValue2[0])
			m_SkillList.SetNpcSkill(4, GetNpcLevelDataFromScript(pLevelScript, "Skill4", nSeries, nLevel, szValue1), GetNpcLevelDataFromScript(pLevelScript, "Level4", nSeries, nLevel, szValue2));
		...
		if (szValue1[0] && szValue2[0])
		{	
			m_SkillList.SetNpcSkill(5, GetNpcLevelDataFromScript(pLevelScript, "AuraSkillId", nSeries, nLevel, szValue1), GetNpcLevelDataFromScript(pLevelScript, "AuraSkillLevel", nSeries, nLevel, szValue2));
		}

		g_NpcSetting.GetString(nNpcTempRow, "PasstSkillId",	"", szValue1, MAX_VALUE_LEN);
		g_NpcSetting.GetString(nNpcTempRow, "PasstSkillLevel", "", szValue2, MAX_VALUE_LEN);
		if (szValue1[0] && szValue2[0])
		{	
			m_SkillList.SetNpcSkill(6, GetNpcLevelDataFromScript(pLevelScript, "PasstSkillId", nSeries, nLevel, szValue1), GetNpcLevelDataFromScript(pLevelScript, "PasstSkillLevel", nSeries, nLevel, szValue2));
		}
		...
		m_LifeReplenish = GetNpcLevelDataFromScript(pLevelScript, "LifeReplenish", nSeries, nLevel, szValue1);
		...
		m_PhysicsDamage.nValue[0] = nParam * GetNpcLevelDataFromScript(pLevelScript, "MinDamage", nSeries, nLevel, nParam1, nParam2, nParam3) / 100;
		...
		m_PhysicsDamage.nValue[2] = nParam * GetNpcLevelDataFromScript(pLevelScript, "MaxDamage", nSeries, nLevel, nParam1, nParam2, nParam3) / 100;

		
		g_NpcSetting.GetString(nNpcTempRow, "RedLum", "", szValue1, MAX_VALUE_LEN);
		m_RedLum = GetNpcLevelDataFromScript(pLevelScript, "RedLum", nSeries, nLevel, szValue1);
		
		g_NpcSetting.GetString(nNpcTempRow, "GreenLum", "", szValue1, MAX_VALUE_LEN);
		m_GreenLum = GetNpcLevelDataFromScript(pLevelScript, "GreenLum", nSeries, nLevel, szValue1);
		
		g_NpcSetting.GetString(nNpcTempRow, "BlueLum", "", szValue1, MAX_VALUE_LEN);
		m_BlueLum = GetNpcLevelDataFromScript(pLevelScript, "BlueLum", nSeries, nLevel, szValue1);
		
	
		g_NpcSetting.GetString(nNpcTempRow, "FireResist", "", szValue1, MAX_VALUE_LEN);
		m_FireResist = GetNpcLevelDataFromScript(pLevelScript, "FireResist", nSeries, nLevel, szValue1);

		g_NpcSetting.GetString(nNpcTempRow, "ColdResist", "", szValue1, MAX_VALUE_LEN);
		m_ColdResist = GetNpcLevelDataFromScript(pLevelScript, "ColdResist", nSeries, nLevel, szValue1);

		g_NpcSetting.GetString(nNpcTempRow, "LightResist", "", szValue1, MAX_VALUE_LEN);
		m_LightResist = GetNpcLevelDataFromScript(pLevelScript, "LightResist", nSeries, nLevel, szValue1);
		
		g_NpcSetting.GetString(nNpcTempRow, "PoisonResist", "", szValue1, MAX_VALUE_LEN);
		m_PoisonResist = GetNpcLevelDataFromScript(pLevelScript, "PoisonResist", nSeries, nLevel, szValue1);

		g_NpcSetting.GetString(nNpcTempRow, "PhysicsResist", "", szValue1, MAX_VALUE_LEN);
		m_PhysicsResist = GetNpcLevelDataFromScript(pLevelScript, "PhysicsResist", nSeries, nLevel, szValue1);
		
		g_NpcSetting.GetString(nNpcTempRow, "PhysicalDamageBase", "", szValue1, MAX_VALUE_LEN);
		m_PhysicsDamage.nValue[0] += GetNpcLevelDataFromScript(pLevelScript, "PhysicalDamageBase", nSeries, nLevel, szValue1);
		m_PhysicsDamage.nValue[2] += GetNpcLevelDataFromScript(pLevelScript, "PhysicalDamageBase", nSeries, nLevel, szValue1);

		g_NpcSetting.GetString(nNpcTempRow, "PhysicalMagicBase", "", szValue1, MAX_VALUE_LEN);
		m_MagicPhysicsDamage.nValue[0] = GetNpcLevelDataFromScript(pLevelScript, "PhysicalMagicBase", nSeries, nLevel, szValue1);
		m_MagicPhysicsDamage.nValue[2] = GetNpcLevelDataFromScript(pLevelScript, "PhysicalMagicBase", nSeries, nLevel, szValue1);

		g_NpcSetting.GetString(nNpcTempRow, "PoisonDamageBase", "", szValue1, MAX_VALUE_LEN);
		m_CurrentPoisonDamage.nValue[0] = GetNpcLevelDataFromScript(pLevelScript, "PoisonDamageBase", nSeries, nLevel, szValue1);
		m_CurrentPoisonDamage.nValue[2] = GetNpcLevelDataFromScript(pLevelScript, "PoisonDamageBase", nSeries, nLevel, szValue1);

		g_NpcSetting.GetString(nNpcTempRow, "PoisonMagicBase", "", szValue1, MAX_VALUE_LEN);
		m_CurrentMagicPoisonDamage.nValue[0] = GetNpcLevelDataFromScript(pLevelScript, "PoisonMagicBase", nSeries, nLevel, szValue1);
		m_CurrentMagicPoisonDamage.nValue[2] = GetNpcLevelDataFromScript(pLevelScript, "PoisonMagicBase", nSeries, nLevel, szValue1);

		g_NpcSetting.GetString(nNpcTempRow, "ColdDamageBase", "", szValue1, MAX_VALUE_LEN);
		m_CurrentColdDamage.nValue[0] = GetNpcLevelDataFromScript(pLevelScript, "ColdDamageBase", nSeries, nLevel, szValue1);
		m_CurrentColdDamage.nValue[2] = GetNpcLevelDataFromScript(pLevelScript, "ColdDamageBase", nSeries, nLevel, szValue1);

		g_NpcSetting.GetString(nNpcTempRow, "ColdMagicBase", "", szValue1, MAX_VALUE_LEN);
		m_CurrentMagicColdDamage.nValue[0] = GetNpcLevelDataFromScript(pLevelScript, "ColdMagicBase", nSeries, nLevel, szValue1);
		m_CurrentMagicColdDamage.nValue[2] = GetNpcLevelDataFromScript(pLevelScript, "ColdMagicBase", nSeries, nLevel, szValue1);

		g_NpcSetting.GetString(nNpcTempRow, "FireDamageBase", "", szValue1, MAX_VALUE_LEN);
		m_CurrentFireDamage.nValue[0] = GetNpcLevelDataFromScript(pLevelScript, "FireDamageBase", nSeries, nLevel, szValue1);
		m_CurrentFireDamage.nValue[2] = GetNpcLevelDataFromScript(pLevelScript, "FireDamageBase", nSeries, nLevel, szValue1);

		g_NpcSetting.GetString(nNpcTempRow, "FireMagicBase", "", szValue1, MAX_VALUE_LEN);
		m_CurrentMagicFireDamage.nValue[0] = GetNpcLevelDataFromScript(pLevelScript, "FireMagicBase", nSeries, nLevel, szValue1);
		m_CurrentMagicFireDamage.nValue[2] = GetNpcLevelDataFromScript(pLevelScript, "FireMagicBase", nSeries, nLevel, szValue1);

		g_NpcSetting.GetString(nNpcTempRow, "LightingDamageBase", "", szValue1, MAX_VALUE_LEN);
		m_CurrentLightDamage.nValue[0] = GetNpcLevelDataFromScript(pLevelScript, "LightingDamageBase", nSeries, nLevel, szValue1);
		m_CurrentLightDamage.nValue[2] = GetNpcLevelDataFromScript(pLevelScript, "LightingDamageBase", nSeries, nLevel, szValue1);

		g_NpcSetting.GetString(nNpcTempRow, "LightingMagicBase", "", szValue1, MAX_VALUE_LEN);
		m_CurrentMagicLightDamage.nValue[0] = GetNpcLevelDataFromScript(pLevelScript, "LightingMagicBase", nSeries, nLevel, szValue1);
		m_CurrentMagicLightDamage.nValue[2] = GetNpcLevelDataFromScript(pLevelScript, "LightingMagicBase", nSeries, nLevel, szValue1);
...
// --
int KNpcTemplate::GetNpcLevelDataFromScript(KLuaScript * pScript, char * szDataName, int nSeries, int nLevel, char * szParam)
{
	int nTopIndex = 0;
	int nReturn = 0;
...
// --
int KNpcTemplate::GetNpcLevelDataFromScript(KLuaScript * pScript, char * szDataName, int nSeries, int nLevel, double nParam1, double nParam2, double nParam3)
{
	int nTopIndex = 0;
	int nReturn = 0;
	pScript->SafeCallBegin(&nTopIndex);
...
KItemDropRate*	KNpcTemplate::UpdateDropRate(const char* pszDropRateFile)
{
	...
	/*
	char szDropFile[200];
	strcpy(szDropFile, pszDropRateFile);
	strlwr(szDropFile);
	KItemDropRateNode DropNode;
	strcpy(DropNode.m_szFileName, szDropFile);
	...
	if (g_ItemDropRateBinTree.Find(DropNode))
	{
		return DropNode.m_pItemDropRate;
	}
	else
	{
		KItemDropRateNode newDropNode;
		...
		newDropNode.m_pItemDropRate = g_GenItemDropRate(szDropFile);
		g_ItemDropRateBinTree.Insert(newDropNode);
		return newDropNode.m_pItemDropRate;
	}
	*/
}
#endif
