...
public:
	...
	void	InitNpcLevelData(KTabFile * pKindFile, int nNpcTemplateId, KLuaScript * pLevelScript, int nLevel, int nSeries = 0);
	static int		GetNpcLevelDataFromScript(KLuaScript * pScript, char * szDataName, int nSeries, int nLevel, char * szParam);
	static int		GetNpcLevelDataFromScript(KLuaScript * pScript, char * szDataName, int nSeries, int nLevel, double nParam1, double nParam2, double nParam3);
