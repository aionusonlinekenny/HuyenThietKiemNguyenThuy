...
public:
	...
	virtual short			GetSkillAttrib() const { return 0; };
	virtual BOOL			IsExpSkill()const{return FALSE;};
	
	virtual unsigned long	GetSkillLevelUpScriptId()const{return 0;} ;
#ifndef _SERVER
	virtual void			DrawSkillIcon(int nSkillID, int x, int y, int Width, int Height) = 0;		//		
#endif
};
